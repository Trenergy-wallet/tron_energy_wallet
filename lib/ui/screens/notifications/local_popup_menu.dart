...
//------------------------------------------------------------------------------
// Взято из исходников с задачей подшаманить под наш UI.
// В частности убрать хардкодные паддинги и настроить дивайдер.
//------------------------------------------------------------------------------
...
class _PopupMenu<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < route.items.length; i += 1) {
      ...
      final double end = clampDouble(start + 1.5 * unit, 0, 1);
    ...
    final CurveTween opacity = CurveTween(curve: const Interval(0, 1.0 / 3.0));
    final CurveTween width = CurveTween(curve: Interval(0, unit));
...
class _PopupMenuDefaultsM2 extends PopupMenuThemeData {
  ...
  @override
  TextStyle? get textStyle => _textTheme.headlineMedium;
